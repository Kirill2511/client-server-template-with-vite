...
import { Tetris } from './hookTry';
import { tetrominoSequence } from './constant'
import { playfield } from './constant'
import { tetrominos } from './constant'
import { colors, sequence } from './constant'
    ...
    useEffect(() => {
        ...
        if (canvas && canvasFigure) {
            ...
            if (context && contextFigure) {
                ...
                // contextFigure.fillRect(0, 0, contextFigure.canvas.width, contextFigure.canvas.height)
            }
        }
    }, [])
    const startGame = () => {
