...
export const createUserRow = async (req: Request, res: Response) => {
  ...
  if (!firstName || !secondName || !id || !login || !email || !phone) {
    res.status(400).send({
      message:
        'firstName, secondName, id, login, email, phone can not be empty!',
    })
    return
  }
  const userID = id
...
export const findUserByNickName = async (req: Request, res: Response) => {
  ...
  await processResult(
    ...
    res,
    'Some error occurred while getting the Users.'
  )
}
...
export const findOne = async (req: Request, res: Response) => {
  ...
  await processResult(
    ...
    res,
    'Some error occurred while getting the User.'
  )
}
...
export const deleteAll = async (_: any, res: Response) => {
  await processResult(
    ...
    res,
    'Some error occurred while deleting the Users.'
  )
}
...
export const getAll = async (_: any, res: Response) => {
  await processResult(
    ...
    res,
    'Some error occurred while getting the Users table.'
  )
}
