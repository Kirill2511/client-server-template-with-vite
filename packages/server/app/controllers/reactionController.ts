...
export const reactionLike = async (req: Request, res: Response) => {
  ...
  await processResult(
    ...
    res,
    'Some error occurred while setting like.'
  )
}
...
export const reactionDislike = async (req: Request, res: Response) => {
  ...
  await processResult(
    ...
    res,
    'Some error occurred while setting dislike.'
  )
}
...
export const getReactionsByPostID = async (req: Request, res: Response) => {
  ...
  await processResult(
    ...
    res,
    'Some error occurred while fetching reactions.'
  )
}
...
export const getLikesByPostID = async (req: Request, res: Response) => {
  ...
  await processResult(
    ...
    res,
    'Some error occurred while fetching likes.'
  )
}
...
export const getDislikesByPostID = async (req: Request, res: Response) => {
  ...
  await processResult(
    ...
    res,
    'Some error occurred while fetching dislikes.'
  )
}
