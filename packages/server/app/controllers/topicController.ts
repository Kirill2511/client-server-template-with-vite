...
export const setLastReply = async (req: Request, res: Response) => {
  ...
  await processResult(
    ...
    res,
    'Some error occurred while updating the topic.'
  )
}
...
export const getTopicList = async (_: any, res: Response) => {
  await processResult(
    ...
    res,
    'Some error occurred while getting the Topics table.'
  )
}
...
export const getTopicListWithCount = async (req: Request, res: Response) => {
  await processResult(
    ...
    res,
    'Some error occurred while getting the Topics.'
  )
}
...
export const deleteOne = async (req: Request, res: Response) => {
  ...
  await processResult(
    ...
    res,
    'Some error occurred while deleting the Theme.'
  )
}
...
export const deleteAll = async (_: any, res: Response) => {
  await processResult(
    ...
    res,
    'Some error occurred while deleting the Topics.'
  )
}
